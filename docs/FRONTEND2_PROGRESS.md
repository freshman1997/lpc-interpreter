...
12. Added frontend2 golden test runner (`lpc_compiler --test`).

## Current sample result

On `build/sample_front2.lpc`:
...
On `build/sample_for_front2.lpc`:
...
On `build/sample_switch_front2.lpc`:
...
On `build/sample_break_continue_front2.lpc`:
...
- Added frontend2 preprocess pass with support for:
  - `#include "..."`
  - `#define NAME value`
  - `#if / #elif / #else / #endif`
  - `#undef NAME`
