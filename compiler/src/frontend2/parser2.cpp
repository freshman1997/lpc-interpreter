#include "frontend2/parser2.h"

namespace lpc {
namespace frontend2 {

std::unique_ptr<Module> Parser2::Parse(const std::vector<Token> &tokens) {
    tokens_ = tokens;
    current_ = 0;
...
std::unique_ptr<Stmt> Parser2::ParseDeclOrStmt() {
...
std::unique_ptr<Stmt> Parser2::ParseInheritDecl() {
...
std::unique_ptr<Stmt> Parser2::ParseClassDecl() {
...
std::unique_ptr<Stmt> Parser2::ParseFunctionDecl(bool lambda) {
...
std::unique_ptr<Stmt> Parser2::ParseStatement() {
...
std::unique_ptr<Stmt> Parser2::ParseFor() {
...
std::unique_ptr<Stmt> Parser2::ParseForeach() {
...
std::unique_ptr<Stmt> Parser2::ParseSwitch() {
...
std::unique_ptr<Stmt> Parser2::ParseBreak() {
...
std::unique_ptr<Stmt> Parser2::ParseContinue() {
...
std::unique_ptr<Stmt> Parser2::ParseCatch() {
...
std::unique_ptr<Stmt> Parser2::ParseIf() {
...
std::unique_ptr<Stmt> Parser2::ParseWhile() {
...
std::unique_ptr<Stmt> Parser2::ParseDoWhile() {
...
std::unique_ptr<Stmt> Parser2::ParseReturn() {
...
std::unique_ptr<Stmt> Parser2::ParseVarDecl() {
...
std::unique_ptr<Stmt> Parser2::ParseVarDeclNoSemi() {
    Expect(TokenKind::KeywordVar, "expect 'var'");
    if (!Expect(TokenKind::Identifier, "expect variable name")) {
        return nullptr;
    }
...
std::unique_ptr<Stmt> Parser2::ParseBlock() {
...
std::unique_ptr<Stmt> Parser2::ParseExprStmt() {
...
std::unique_ptr<Stmt> Parser2::ParseTypedVarDeclWithPrefix(
...
std::unique_ptr<Stmt> Parser2::ParseTypedFunctionDeclWithPrefix(
    const std::vector<std::string> &decorators,
...
std::unique_ptr<Expr> Parser2::ParseExpr() {
    return ParseAssignment();
}

std::unique_ptr<Expr> Parser2::ParseAssignment() {
...
std::unique_ptr<Expr> Parser2::ParseTernary() {
...
std::unique_ptr<Expr> Parser2::ParseAdditive() {
...
std::unique_ptr<Expr> Parser2::ParseLogicalOr() {
...
std::unique_ptr<Expr> Parser2::ParseLogicalAnd() {
...
std::unique_ptr<Expr> Parser2::ParseBitOr() {
...
std::unique_ptr<Expr> Parser2::ParseBitXor() {
...
std::unique_ptr<Expr> Parser2::ParseBitAnd() {
...
std::unique_ptr<Expr> Parser2::ParseEquality() {
...
std::unique_ptr<Expr> Parser2::ParseRelational() {
...
std::unique_ptr<Expr> Parser2::ParseShift() {
...
std::unique_ptr<Expr> Parser2::ParseMultiplicative() {
...
std::unique_ptr<Expr> Parser2::ParseUnary() {
...
std::unique_ptr<Expr> Parser2::ParsePostfix() {
...
std::unique_ptr<Expr> Parser2::ParsePrimary() {
...
std::unique_ptr<Expr> Parser2::ParseArrayLiteralExpr() {
...
std::unique_ptr<Expr> Parser2::ParseMappingLiteralExpr() {
...
std::unique_ptr<Expr> Parser2::ParseLambdaExpr() {
    if (!Check(TokenKind::KeywordFun)) {
        if (diag_) {
...
bool Parser2::Match(TokenKind kind) {
    if (!Check(kind)) {
        return false;
    }
    Advance();
...
bool Parser2::Check(TokenKind kind) const {
    if (IsAtEnd()) {
...
const Token &Parser2::Peek() const {
    return tokens_[current_];
}

const Token &Parser2::Previous() const {
    return tokens_[current_ - 1];
}

bool Parser2::IsAtEnd() const {
    return current_ >= tokens_.size() || tokens_[current_].kind == TokenKind::EndOfFile;
}

bool Parser2::Expect(TokenKind kind, const char *message) {
    if (Check(kind)) {
        Advance();
        return true;
    }
...
bool Parser2::IsDecoratorToken(TokenKind kind) const {
...
bool Parser2::IsTypeStartToken(TokenKind kind) const {
...
std::string Parser2::TypeNameFromToken(const Token &tok) const {
    switch (tok.kind) {
...
bool Parser2::ParseOptionalType(std::string *decl_type, bool *is_pointer) {
...
std::vector<std::string> Parser2::ParseDecorators() {
